...
<style type ="text/css">
    ...
    .wrap .info {width: 286px;height: 240px;border-radius: 5px;border-bottom: 2px solid #ccc;border-right: 1px solid #ccc;overflow: hidden;background: #fff;}
    .wrap .info:nth-child(1) {border: 0;box-shadow: 0px 1px 2px #888;}
    .info .title {padding: 5px 0 0 10px;height: 30px;background: #eee;border-bottom: 1px solid #ddd;font-size: 18px;font-weight: bold;}
    .info .close {position: absolute;top: 10px;right: 10px;color: #888;width: 17px;height: 17px;background: url('http://t1.daumcdn.net/localimg/localimages/07/mapapidoc/overlay_close.png');}
    .info .close:hover {cursor: pointer;}
    .info .body {position: relative; display:inline-block;}
...
<body>
	...
	<script type="text/javascript">
		...
		mapOption = {
			center : new kakao.maps.LatLng(37.562894, 127.000486), // 지도의 중심좌표
			level : 3 // 지도의 초기 레벨
		};
		...
		kakao.maps.event.addListener(map, 'click', function(mouseEvent) {
			...
			searchDetailAddrFromCoords(mouseEvent.latLng, function(result,
				...
				if (status === kakao.maps.services.Status.OK) {
                    ...
                    '        <div class="body">' + 
                    '            <div class="desc">' + 
                    '                <div class="ellipsis"> '+ jibunAddr +'</div>' + 
                    '                <div class="jibun ellipsis">'+ detailAddr +'</div>' +
                    '                <div class="ellipsis">남녀성비</div>' +
